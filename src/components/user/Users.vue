<template>
  <div>
          ...
          <template slot-scope="scope">
            ...
            >
              <el-button
                ...
                size="mini"
                @click="showSetingRoledialog(scope.row)"
              ></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="editDialogVisible = !editDialogVisible"
          >取 消</el-button
        >
    ...
    <el-dialog
      title="分配角色"
      :visible.sync="setingRoledialogVisible"
      width="30%"
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setingRoledialogVisible = false">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    async showSetingRoledialog(userInfo) {
      //分配角色对话框展示
      this.userInfo = userInfo;
      //获取角色列表
      const { data: res } = await this.$http.get("roles");
      this.setingRoledialogVisible = true;
      this.roleList = res.data;
    },
    async saveRoleInfo(){ //保存角色分配
        ...
        this.getUserList();
        this.seletedRoleId = ''; //清空选择
        this.setingRoledialogVisible = false;
    }
  },
